...
const EventEditModal = ({ event, isOpen, onClose, onUpdate }) => {
  ...
  useEffect(() => {
    if (event) {
      console.log('EventEditModal received event:', event); // Debug log
      setFormData({
        title: event.title || '',
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      const updatedEvent = {
        ...event, // Preserve all existing event data (like registered, image, etc.)
      ...
      console.log('Final updated event:', updatedEvent); // Debug log
